# 👋 안녕하세요, 비즈니스 가치를 코드로 증명하는 개발자 김도현입니다.
...
[📁 VERNALIS 소스코드](https://github.com/dh4833/vernalis-ats)
...
[📁 ERP Bridge 소스코드](https://github.com/dh4833/erp-bridge)
...
**"기술로 생각하고, 데이터로 증명하는 개발자 김도현이었습니다. 감사합니다."**
