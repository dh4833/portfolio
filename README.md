...
> **비즈니스 문제를 기술로 해결하는 개발자**

Spring Boot 기반의 개발자로, 세미 프로젝트에서 얻은 아이디어를 실제 서비스 수준의 팀 프로젝트로 확장한 경험을 갖추고 있습니다.  
동기 최우수 프로젝트(1위)를 수상한 VERNALIS ATS의 팀장을 맡아 DB 설계와 핵심 기능 구현을 주도하였습니다.
...
> ERP Bridge(세미 프로젝트)에서 "사람을 관리하는 인사 시스템"의 복잡성을 처음 경험하며 얻은 아이디어를,  
> 팀 프로젝트 VERNALIS ATS에서 **채용 도메인으로 확장·발전**시켰습니다.

---

### 1. VERNALIS ATS · 채용 지원자 관리 시스템 (팀 프로젝트)
...
### 2. ERP Bridge · 중소기업 경량형 통합 ERP (세미 프로젝트)

> 개인 세미 프로젝트 · 2025.03 ~ 2025.05

📁 [소스코드 보러가기](https://github.com/dh4833/erp-bridge)

#### 🎯 해결하고자 한 문제
대기업 중심의 SAP·Oracle ERP는 도입 비용과 학습 곡선이 높아 중소·중견기업이 접근하기 어렵습니다.  
**중소기업이 쉽게 도입할 수 있는 웹 기반 경량형 ERP 아이디어를 세미 프로젝트로 구체화**하여, 인사·근태·급여·연차 업무를 하나의 플랫폼에서 처리하는 구조를 직접 설계·구현하였습니다.  
이 프로젝트에서 얻은 **"사람을 관리하는 시스템"의 데이터 흐름에 대한 통찰**이 이후 팀 프로젝트 VERNALIS ATS의 직접적인 영감이 되었습니다.
...
- **인사 데이터의 흐름 이해**를 바탕으로 이후 VERNALIS ATS 기획으로 확장
