...
### ER 다이어그램
![VERNALIS ER Diagram](./images/VERNALIS_ER_Diagram.png)

### 핵심 코드
**BCrypt 단방향 암호화**
![BCrypt Core Code](./images/BCrypt_Code.png)

**서버사이드 페이지네이션**
![Pagination Core Code](./images/Pagination_Code.png)

**대시보드 KPI + Gemini AI 분석**
![Dashboard AI Core Code](./images/Dashboard_AI_Code.png)
...
### ER 다이어그램
![ERP Bridge ER Diagram](./images/ERP_Bridge_ER_Diagram.png)

### 핵심 코드
**4대보험 급여 자동 계산**
![Salary Calculation Core Code](./images/Salary_Calculation_Code.png)
